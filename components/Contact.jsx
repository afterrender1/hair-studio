...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (!isFormValid) return; // prevent if empty fields
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl font-semibold text-center mb-3 text-sky-400">
            Hair Coaching Inquiry
          </h2>
          <p className="mt-4 mb-9 text-gray-700 text-lg md:text-2xl max-w-2xl mx-auto">
            Ready to elevate your hair skills? Let’s connect and start your
            journey with personalized coaching.
          </p>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5" noValidate>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 rounded-lg border border-gray-200 focus:ring-2 focus:ring-sky-400 focus:border-transparent outline-none bg-white transition-colors"
                  />
                </div>
                <div>
                  <label
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleInputChange}
                  placeholder="Tell us about your hair background and what you want to achieve..."
                  className="w-full px-4 py-2 rounded-lg border border-gray-200 focus:ring-2 focus:ring-sky-400 focus:border-transparent outline-none bg-white transition-colors resize-y"
                ></textarea>
              </div>
          ...
          <div className="space-y-8">
              ...
              <ul className="space-y-5">
                <li className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:info@luxestudio.com"
                ...
                <li className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Karachi — RJ Mall, Gate No 3</p>
                  </div>
                </li>
                <li className="flex items-center gap-4">
                  <div className="p-3 rounded-lg bg-gradient-to-r from-sky-400 to-blue-500 text-white">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Mon–Sat • 11 AM – 8 PM</p>
                  </div>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white/90 backdrop-blur-md border border-sky-200 rounded-2xl shadow-lg p-6 md:p-8 text-center hover:shadow-xl transition-all duration-300">
              ...
              <button
                ...
                className="w-full py-3 px-6 rounded-lg border text-green-600 font-semibold hover:bg-green-600 hover:text-white transition-all duration-300"
              >
